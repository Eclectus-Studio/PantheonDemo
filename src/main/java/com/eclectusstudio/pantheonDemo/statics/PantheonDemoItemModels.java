...
public class PantheonDemoItemModels {
    ...
    public static final ItemModels RUBY_WOLF_ARMOR_ITEM_MODEL = SimpleItemModels.generated(PantheonDemoItemLocations.RUBY_WOLF_ARMOR_LOCATION).createItemModels();
